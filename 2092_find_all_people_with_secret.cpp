...
// we need to introduce the reset for this question
// note, the reset is doable since for this question, only nodes know the secret will be connected
// others will just link to itself
...
public:
    vector<int> findAllPeople(int n, vector<vector<int>>& meetings, int firstPerson) {
        // Sort meetings in increasing order of time using lambda function
